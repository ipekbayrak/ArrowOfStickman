...
public class YeniOk {
    ...
    public boolean saplandi = false;

    public YeniOk(World world, float x, float y, Vector2 velocity){
        this.world = world;
        this.velocity = velocity;
        img1 = MainClass.mainClass.assets.manager.get("yeniOk.png", Texture.class);
        img3 = MainClass.mainClass.assets.manager.get("tuy.png", Texture.class);

       // img2 = MainClass.mainClass.assets.manager.get("ok.png", Texture.class);

        sprite1 = spriteCreator(img1, x,y );
        sprite3 = spriteCreator(img3,x-10,y);

      ///  sprite2 = spriteCreator(img2, x+10,y );
     ...
     //   PolygonShape shape2 = polygonShapeCreatorAsPolygon(sprite2 );
        ...
        body1 = world.createBody(bodyDefCreator(sprite1,0f,0));
        //body2 = world.createBody(bodyDefCreator(sprite2,0f,0));  //ok ucu
        body3 = world.createBody(bodyDefCreator(sprite3,20f,0));

        FixtureDef fixtureDef1 = fixtureDefCreator ( shape1 ,1f,0.3f,c.ARROW_ENTITY, (short) (c.WORLD_ENTITY | c.STICK_ENTITY| c.ARROW_ENTITY));
       // FixtureDef fixtureDef2 = fixtureDefCreator ( shape2 ,0f,00f,c.ARROW_ENTITY, (short) c.WORLD_ENTITY);
        FixtureDef fixtureDef3 = fixtureDefCreator ( shape3 ,0.1f,0f,c.ARROW_ENTITY, (short) (c.WORLD_ENTITY | c.STICK_ENTITY| c.ARROW_ENTITY));
       ...
       // body2.createFixture(fixtureDef2);
        ...
        joint1 = world.createJoint(revoluteJointDefCreatorSolOrta(body1,body3,sprite1,sprite3,false));
       // joint2 = world.createJoint(revoluteJointDefCreatorSagOrta(body1,body2,sprite1,sprite2,false));
    ...
    private PolygonShape polygonShapeCreatorAsPolygon(Sprite sprite) {
        ...
        Vector2 vector2 = new Vector2(sprite.getWidth() /3 / c.PIXELS_TO_METERS,-sprite.getHeight() /2 / c.PIXELS_TO_METERS);
        Vector2 vector3 = new Vector2(sprite.getWidth() /2 / c.PIXELS_TO_METERS,0f);
        Vector2 vector4 = new Vector2(sprite.getWidth() /3 / c.PIXELS_TO_METERS,sprite.getHeight() /2 / c.PIXELS_TO_METERS);
    ...
    private JointDef revoluteJointDefCreatorSagOrta(Body bodyA, Body bodyB, Sprite spriteA, Sprite spriteB , Boolean collideConnected) {
    ...
    public void yapis(Body body){
        ...
        weldJointDef.dampingRatio=0.1f;
        weldJointDef.referenceAngle = body.getAngle() - body1.getAngle() ;
