...
public class StickPlayer {
    ...
    Joint yayJoint;
    Joint platformJoint;
    public Body stickman1 , stickman2, stickman3, stickman4, stickman5, stickman6 ,stickman7;
    ...
    public StickPlayer(final com.kardelenapp.arrowofstickman.GameWorld gameWorld, final float x, final float y){
        this.x = x;
        this.y = y;
        ...
        this.platform = new com.kardelenapp.arrowofstickman.Platform(world,x-70,y-20);

        yay = new com.kardelenapp.arrowofstickman.Yay(world, x , y+ 40, true);



        yayJoint = world.createJoint(revoluteJointDefCreatorSagOrta(stickman5,yay.body1,Sstickman5,yay.sprite1,false));
        platformJoint = world.createJoint(revoluteJointDefCreatorSolAlt( stickman2,platform.body1,Sstickman2,platform.sprite1,false));
    ...
    private JointDef revoluteJointDefCreatorSolAlt(Body bodyA, Body bodyB, Sprite spriteA, Sprite spriteB ,Boolean collideConnected) {
        ...
        revoluteJointDef.localAnchorB.set(spriteB.getWidth()/5/ c.PIXELS_TO_METERS,spriteB.getHeight()/2/ c.PIXELS_TO_METERS);
        return revoluteJointDef;
    }
    ...
    public void getPositionHelper(){
        ...
        if (alive){
            stickman7.setLinearVelocity(0,1f);
        }
        else{
            disjointer();
            ...
            //okçuları durdur
            //3 sn sondra screen at
            // ama şimdilik başa dön
