...
public class Platform {
    ...
    public Platform(World world, float x, float y){
        this.world  = world ;
        img1 =  mainClass.assets.manager.get("platform.png", Texture.class);

        sprite1 = spriteCreator(img1,x,y);


        PolygonShape shape1 = polygonShapeCreator(sprite1);

        body1 = world.createBody(bodyDefCreator(sprite1,0,0));

        FixtureDef fixtureDef1 = fixtureDefCreator ( shape1 ,0.5f,0.1f,c.PLATFORM_ENTITY, (short) (c.PLATFORM_ENTITY | c.STICK_ENTITY| c.ARROW_ENTITY));
